...
from backend.modules.dataloaders import GoogleDriveLoader
...
def main():
    ...
    data_source = DataSource(
        type="google_drive", uri=settings.GOOGLE_DRIVE_FOLDER_ID, fqn="google_drive_test_source"
    )
    ...
    dest_dir = "test/google_drive_output"
    batch_size = 10
    ...
    # Load data using the GoogleDriveLoader
