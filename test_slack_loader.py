...
from backend.modules.dataloaders import SlackLoader
...
def main():
    ...
    data_source = DataSource(
        type="slack", uri="https://sambanova.slack.com", fqn="slack_test_source"
    )
    ...
    # Load data using the SlackLoader
