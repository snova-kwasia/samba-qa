...
from backend.modules.dataloaders import JiraLoader
...
def main():
    ...
    data_source = DataSource(
        type="jira", uri=settings.JIRA_URL, fqn="jira_test_source"
    )

    # Initialize the JiraLoader
    loader = JiraLoader()

    # Set up test parameters
    dest_dir = "test/jira_output"
    batch_size = 10
    ...
    # Load data using the JiraLoader
